        ...
        <div class="content-wrapper" style="min-height: 1744.3px;">
                    ...
                    <div class="col-sm-1">
                        <div class="custom-dropdown">
                            ...
                            <button class="custom-dropdown-toggle btn" type="button" data-toggle="dropdown"
                                ...
                                <b>Teacher</b> <!-- Updated the button text -->
            ...
            <section id="frmCsvGroup" class="container-fluid">
                <form id="uploadCSVForm" method="post" enctype="multipart/form-data">
                    ...
                    <div id="response"></div>
                    <div class="form-group">
                        <input type="submit" name="upload_excel" id="upload_excel" value="upload_excel" class="btn btn-info" />
            ...
            <section class="content" id="mainContent">
                ...
                <?php include_once "../PagesContent/UserContent/UserTable/TeacherTableContent.php";?>
            </section>
        </div>
