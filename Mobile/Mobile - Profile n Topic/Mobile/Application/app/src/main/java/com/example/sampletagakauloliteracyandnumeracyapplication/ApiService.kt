...
class ApiService {
    ...
    companion object {
        ...
        fun login(context: Context, username: String, password: String, callback: ApiCallback) {
        ...
        private fun handleResponse(context: Context, response: String?, callback: ApiCallback) {
            if (response != null) {
                try {
