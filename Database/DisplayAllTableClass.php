    ...
    function displayTeacher($status){
        ...
        if($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
                ...
                echo "<td><a href='#' class='assign_module_btn text-warning' type='button' data-toggle='modal' data-target='#assign_class_modal' data-toggle='tooltip' title='Assign Module' data-id='".$row["user_info_id"]."'><i class='fa fa-file-text-o'></i></a></td>";
